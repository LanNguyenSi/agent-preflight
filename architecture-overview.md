# Architecture Overview: agent-preflight
...
- Async worker infrastructure may be premature if workflows stay simple.
...
- act (nektos/act) for GitHub Actions simulation
